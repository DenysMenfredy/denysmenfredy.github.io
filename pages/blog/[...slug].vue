<template>
    ...
    <article class="w-full max-w-4xl mx-auto px-4 py-8">
        ...
        <!-- Post Content -->
        <div class="prose prose-lg max-w-none dark:prose-invert prose-h1:text-3xl prose-h2:text-2xl prose-h3:text-xl prose-h4:text-lg prose-h5:text-base prose-h6:text-sm prose-headings:text-gray-900 dark:prose-headings:text-slate-100 prose-headings:font-bold prose-p:text-gray-700 dark:prose-p:text-gray-300 prose-p:leading-relaxed prose-strong:text-gray-900 dark:prose-strong:text-slate-100 prose-blockquote:border-emerald-500 dark:prose-blockquote:border-emerald-600 prose-blockquote:bg-emerald-50 dark:prose-blockquote:bg-stone-800 prose-blockquote:border-l-4 prose-blockquote:pl-4 prose-blockquote:py-2 prose-ul:text-gray-700 dark:prose-ul:text-gray-300 prose-ol:text-gray-700 dark:prose-ol:text-gray-300 prose-li:text-gray-700 dark:prose-li:text-gray-300 prose-a:text-emerald-600 dark:prose-a:text-emerald-400 hover:prose-a:text-emerald-700 dark:hover:prose-a:text-emerald-300 prose-a:no-underline hover:prose-a:underline">
